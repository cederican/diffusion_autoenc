...
def mri_autoenc_latent():
    ...
    conf.eval_ema_every_samples = 5_000_000                # edit for dataset
    conf.eval_every_samples = 5_000_000                    # edit for dataset
    conf.sample_every_samples = 1_000_000                  # edit for dataset
    conf.eval_num_images = 10_000 
    conf.name = 'mri_autoenc_latent_nine'
    return conf
